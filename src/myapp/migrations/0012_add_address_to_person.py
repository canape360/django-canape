...
def add_address_column(apps, schema_editor):
    ...
    if vendor == "sqlite":
        ...
        if "address" not in cols:
            schema_editor.execute("ALTER TABLE person ADD COLUMN address varchar(255);")

    elif vendor == "postgresql":
        schema_editor.execute("ALTER TABLE person ADD COLUMN IF NOT EXISTS address varchar(255);")
